...
function fCloseCurtain () {
    $('#divShadowCurtain').fadeOut('slow', function() {$('#divShadowCurtain').empty();});
...
function fInstProfilePhoto(photoType) {
    ...
    fCreateUploader('UploadPhotoURL',['bmp','gif','jpg','png','tif','jpeg'],false,photoType,'CallBackGrpPhoto');
}
function fCreateUploader(elemId,extType, multi,ft, callBackId) {
