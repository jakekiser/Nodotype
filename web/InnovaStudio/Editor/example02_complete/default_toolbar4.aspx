    ...
    <script language="VB" runat="server">
        Sub Page_Load(Source As Object, E As EventArgs)
            ...
            oEdit1.ToolbarMode = 3
             ...
             Dim grpEdit As ISGroup = New ISGroup("grpEdit", "", New String() {"XHTMLSource", "FullScreen", "Search", "RemoveFormat", "Undo", "Redo", "Cut", "Copy", "Paste", "PasteWord", "PasteText"})
             Dim grpFont As ISGroup = New ISGroup("grpFont", "", New String() {"Bold", "Italic", "Underline", "Strikethrough", "Superscript", "ForeColor", "BackColor"})
             Dim grpPara As ISGroup = New ISGroup("grpPara", "", New String() {"JustifyLeft", "JustifyCenter", "JustifyRight", "JustifyFull", "Numbering", "Bullets", "Indent", "Outdent"})
             Dim grpInsert As ISGroup = New ISGroup("Insert", "", New String() {"Hyperlink", "Bookmark", "Image", "Flash", "YoutubeVideo"})
             Dim grpFormat As ISGroup = New ISGroup("Format", "", New String() { "StyleAndFormatting", "Paragraph", "FontName", "FontSize", "Styles"})
             Dim grpTables As ISGroup = New ISGroup("grpTables", "", New String() {"Table", "Guidelines", "AutoTable"})
             Dim grpMedia As ISGroup = New ISGroup("grpMedia", "", New String() {"Media", "Characters", "Line"})
             Dim grpResource As ISGroup = New ISGroup("grpResource", "", New String() {"InternalLink", "CustomObject"})
 
             Dim tabHome = New ISTab("tabHome", "Home")
             tabHome.Groups.AddRange(New ISGroup() {grpEdit, grpPara, grpFormat,  grpFont, grpInsert, grpMedia, grpTables, grpResource})
