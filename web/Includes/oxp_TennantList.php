<?php
    ...
    echo '<div id="NewBtn" title="Add XPage site"><a class="Add" href="javascript:void(0);" onclick="fDisplayAjaxBox(\'FUNC=CREATETENNANT&ntnt=1\',0);"><img src="/images/spacer.gif"/></a></div>';
    echo '<div id="TrashBtn" title="View recycle bin"><a class="Trash" href="javascript:void(0);" onclick="fDisplayAjaxBox(\'FUNC=TRASHSITE&tnt=1'.$iTennantId.'\',0);"><img src="/images/spacer.gif"/></a></div>';
    ...
    .' where t.UserId=\''.$Persist_UserId.'\' and t.Active=1'
